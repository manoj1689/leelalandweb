      ...
      >
        ...
        >
          ...
          {chatHistory.map((entry, index) => (
            <div
              key={index}
              className={`flex container mx-auto items-center ${entry.role === 'user' ? 'justify-end' : 'justify-start'} my-4`}
            >
              ...
              <div
                className={`p-4 rounded-lg shadow-md ${entry.role === 'user' ? 'bg-[#655762] text-white' : 'bg-[#3A5470] text-white'
                  } max-w-2xl`}
              >
